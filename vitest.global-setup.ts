...
// same Vite/Astro cache - see the run this replaced, where two concurrent
// builds crashed astro outright. Building once here, before any test file
// starts, is what makes a second build-output test file safe to add later.
